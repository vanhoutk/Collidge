...
public class EnemySets
{
    ...
    EnemySets()
    {
        EnemyCollections.put("Empty", fillArrays("","","",""));     //for example this enemy set is called empty and has blank enemies
    ...
    //puts the numbers of enemies in an array
    ...
    public Enemy[] getEnemies(String name)
    {
        ...
        //handles up to 4 enemies within the Enemyset. If the enemy at Enemyset[i] isn't blank,
        for(int i=0;i<4;i++)
        {
