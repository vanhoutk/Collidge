...
public class Combo
{
    ...
    Combo()
    {
        ...
        screenMask=new Sprite(texture);     //this essentially makes the screen look darker while inputting a combo
        screenMask.setSize(Gdx.graphics.getWidth(),Gdx.graphics.getHeight());
        screenMask.setPosition(0f,0f);
        screenMask.setAlpha(.5f);
        texture=new Texture("buttonRound_grey.png");    //combo tap image placeholder
