...
public class WinState extends GameState {
    ...
    public  void draw()
    {
        ...
        winfont.draw(batch, "" + player.getLevel(), ExpBorder.getX() + ExpBorder.getHeight()/8, ExpBorder.getY() + ExpBorder.getHeight()*3/5);
        winfont.draw(batch, "" + (player.getLevel()+1), ExpBorder.getX() + ExpBorder.getWidth()*12/13 , ExpBorder.getY() + ExpBorder.getHeight()*3/5);
